...
class AnnoyIndex:
    ...
    def get_nns_by_vector(
        self, vector: Iterable[float], n: int, search_k: int = ..., include_distances: Literal[False] = ...
    ) -> list[int]: ...
    @overload
    def get_nns_by_vector(
        self, vector: Iterable[float], n: int, search_k: int, include_distances: Literal[True]
    ) -> tuple[list[int], list[float]]: ...
    @overload
    def get_nns_by_vector(
        self, vector: Iterable[float], n: int, search_k: int = ..., *, include_distances: Literal[True]
